...
namespace MyLaboratorio.Data
{
    ...
    public class BusinessRulesBase : ActionHandlerBase, MyLaboratorio.Data.IRowHandler, MyLaboratorio.Data.IDataFilter, MyLaboratorio.Data.IDataFilter2
    {
        ...
        {
            if (_junctionTableFieldName != fieldName)
            {
                _junctionTableFieldName = fieldName;
            ...
            if (_junctionTableMap == null)
            {
                ...
                ViewPage manyToManyPage = ControllerFactory.CreateDataController().GetPage(targetController, null, request);
            ...
            string key = Convert.ToString(SelectFieldValue(primaryKeyField));
            List<string> keyValues = null;
            if (_junctionTableMap.TryGetValue(key, out keyValues))
            	UpdateFieldValue(fieldName, String.Join(",", keyValues.ToArray()));
        }
